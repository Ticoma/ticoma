...
func TestNodeCacheInit(t *testing.T) {
	...
	// put first pkg in
	pkgStr := utils.StringifyADP(pkg, false)
	nc.Put([]byte(pkgStr))
	...
	prevADP := utils.StripADPFromTimestamp(&prev)
	currADP := utils.StripADPFromTimestamp(&curr)
...
func TestNodeCacheGetters(t *testing.T) {
	...
	pkgStr2 := utils.StringifyADP(pkg2, false)
	...
	p0cPrevADP := utils.StripADPFromTimestamp(&p0cPrev)
	p0cCurrADP := utils.StripADPFromTimestamp(&p0cCurr)
	...
	p0selfADP := utils.StripADPFromTimestamp(&p0self)
...
func TestNodeCachePut(t *testing.T) {
	...
	pkg2Str := utils.StringifyADP(pkg2, false)
	...
	p0prevADP := utils.StripADPFromTimestamp(&p0prev)
	p0prev2ADP := utils.StripADPFromTimestamp(&p0prev2)
...
func TestNodeCacheInvalidPutRequest(t *testing.T) {
	...
	pkg0Str := utils.StringifyADP(pkg0, false)
	...
	pkg0invalidStr := utils.StringifyADP(pkg0invalid, false)
	...
	NcCurrADP := utils.StripADPFromTimestamp(&NcCache[1])
	Nc2CurrADP := utils.StripADPFromTimestamp(&Nc2Cache[1])
	...
	pkg0moveStr := utils.StringifyADP(pkg0move, false)
	...
	NcPlayer0CurrADP := utils.StripADPFromTimestamp(&Ncp0curr)
	Nc2Player0CurrADP := utils.StripADPFromTimestamp(&Nc2p0curr)
	...
	cheatPkgStr := utils.StringifyADP(cheatPkg, false)
	...
	NcCurrADP2 := utils.StripADPFromTimestamp(&NcCurr)
	Nc2CurrADP2 := utils.StripADPFromTimestamp(&Nc2Curr)
